  ...
  return (
    <div className=" flex justify-between items-center h-24 max-w-[1240px] mx-auto px-4 text-white">
      ...
      <ul className='hidden md:flex'>
        ...
        <li className='p-4 hover:text-[#00df9a] duration-300'>Comapany</li>
      ...
      <h1 className="w-full text-3xl font-bold text-[#00df9a] m-4">REACT.JS</h1>

        <ul className='uppercase p-4'>
        <li className='p-4 boder-b border-gray-600 hover:text-[#00df9a] duration-300'>Home</li>
        <li className='p-4 hover:text-[#00df9a] duration-300'>Comapany</li>
        <li className='p-4 hover:text-[#00df9a] duration-300'>Resources</li>
        <li className='p-4 hover:text-[#00df9a] duration-300'>About</li>
        <li className='p-4 hover:text-[#00df9a] duration-300'>Contact</li>
